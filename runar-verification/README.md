...
`tests/PipelineGolden.lean`). All 74 discovered fixtures are bucketed
...
`pipelineGolden` reports 58/74 byte-exact across its tracked
...
`pipelineGolden` is the default fast byte-exact gate (58/74).
