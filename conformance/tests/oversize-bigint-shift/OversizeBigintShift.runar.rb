...
# back to a JSON number and the checked-in expected-ir.json really does pin the
...
class OversizeBigintShift < Runar::StatefulSmartContract
  prop :out, Bigint
